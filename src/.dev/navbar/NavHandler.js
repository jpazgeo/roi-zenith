class NavHandler {
    ...
    */
    generateContent(){
        ...
        let centerPane            = document.getElementById('roiZenith');
    ...
    enableDisplayToggle(){
        ...
        displayToggle.addEventListener('click', () => {
            if(this.focus){
                ...
                global.geotab.addin.roiZenith.blur();
            } else {
                displayToggle.innerHTML = 'Blur add-in';
                global.geotab.addin.roiZenith.focus(global.api, global.state);
            }
    ...
    listenToHash(){
        ...
        setInterval(()=>{
            if(window.location.hash !== this.storedHash){
                this.storedHash = window.location.hash;
                if(this.storedHash !== '#' + 'roiZenith'){
                    geotab.addin.roiZenith.blur();
                } else {
                    geotab.addin.roiZenith.focus(global.api, global.state);
                }
            }
        }, 100);
    }
